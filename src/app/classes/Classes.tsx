...
const Classes = () => {
  return (
    <div className="flex flex-col bg-white">
      ...
      <div className="justify-center items-center px-16 py-14 mt-16 w-full text-7xl italic font-bold bg-orange-50 text-zinc-800 max-md:px-5 max-md:mt-10 max-md:max-w-full max-md:text-4xl">
